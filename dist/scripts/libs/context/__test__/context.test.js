...
var ContextRender_1 = require("../ContextRender");
...
describe('Lib Context', function () {
    ...
    // #Foo Component
    var renderFoo = jest.fn(function () {
        var props = [];
    ...
    var Foo = withContext_1.withContext('foo')(FooComponent);
    // #Bar Component
    var renderBar = jest.fn(function () {
        var props = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            props[_i] = arguments[_i];
        }
    ...
    var Bar = withContext_1.withContext('bar')(BarComponent);
    var contextRender = jest.fn(function () {
        var props = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            props[_i] = arguments[_i];
        }
    ...
    var AppRenderer = react_test_renderer_1.default.create(React.createElement(ContextFactory_1.ContextFactory, { context: appContext, initContextValue: appContextValue },
        React.createElement(Foo, null),
        React.createElement(Bar, null),
        React.createElement(ContextRender_1.ContextRender, { keys: ['foo'] }, function (props) { return contextRender(props); })));
    var AppRendererInstance = AppRenderer.getInstance();
    var ProviderTestInstance = AppRenderer.root.findByType(ContextProvider_1.ContextProvider);
    ...
    it('should Foo re-render went it own props changed', function () {
        ...
        AppRenderer.update(React.createElement(ContextFactory_1.ContextFactory, { context: appContext, initContextValue: appContextValue },

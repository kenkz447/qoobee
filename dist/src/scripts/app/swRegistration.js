...
exports.swRegistration = function (props) {
    ...
    var onUpdateFound = props.onUpdateFound, _a = props.workerUrl, workerUrl = _a === void 0 ? '/static/service-worker.js' : _a, _b = props.workerOptions, workerOptions = _b === void 0 ? { scope: '/' } : _b;
    var loadServiceWorker = function () { return __awaiter(_this, void 0, void 0, function () {
